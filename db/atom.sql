...
--   `LICENSE_VERIFICATION_KEY` VARCHAR(2500) NOT NULL,
...
--   FOREIGN KEY (`LICENSE_ID`) REFERENCES license_verification_table(`LICENSE_ID`) ON UPDATE CASCADE ON DELETE SET NULL
-- );
...
--   PRIMARY KEY (`ID`),
--   FOREIGN KEY (`ROLE_ID`) REFERENCES user_roles(`ROLE_ID`) ON UPDATE CASCADE ON DELETE SET NULL,
--   FOREIGN KEY (`END_USER_ID`) REFERENCES end_user_table(`END_USER_ID`) ON UPDATE CASCADE ON DELETE SET NULL
-- );
...
--   `PASSWORD_GROUP_ID` INT AUTO_INCREMENT NOT NULL,
--   `PASSWORD_GROUP` VARCHAR(50) NOT NULL UNIQUE,
...
--   `PASSWORD_GROUP_ID` VARCHAR(50) NULL,

--   `CREATION_DATE` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
--   `MODIFICATION_DATE` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,

--   PRIMARY KEY (`ATOM_ID`),
--   FOREIGN KEY (`PASSWORD_GROUP_ID`) REFERENCES password_group_table(`PASSWORD_GROUP_ID`) ON UPDATE CASCADE ON DELETE NULL,
--   FOREIGN KEY (`RACK_ID`) REFERENCES rack_table(`RACK_ID`) ON UPDATE CASCADE ON DELETE NULL
-- );
...
--   PRIMARY KEY (`UAM_ID`),
--   FOREIGN KEY (`ATOM_ID`) REFERENCES atom_table (`ATOM_ID`) ON DELETE CASCADE ON UPDATE CASCADE
-- );
...
--   `PAUSE_MIN` INT NULL,
--   `ALERT_ACTIVE` VARCHAR(50) NOT NULL DEFAULT 'Active',
...
-- CREATE TABLE IF NOT EXISTS `AtomDB`.`dbm_password_group_table`(
...
-- CREATE TABLE IF NOT EXISTS `AtomDB`.`server_table` (
...
--     FOREIGN KEY (`PASSWORD_GROUP`) REFERENCES dbm_password_group_table(`PASSWORD_GROUP`)
-- );
