...
def list_of_site_to_site_vpn(service_name: str = "ec2") -> dict:
    obj = ec2Driver(**account_details)
    all_site_to_site_vpn_connections = obj.get_all_site_to_site_vpn_connections(service_name)
...
def list_of_security_groups(service_name: str = "ec2") -> dict:
    obj = ec2Driver(**account_details)
    all_security_groups = obj.get_all_security_groups(service_name=service_name)
...
def list_of_network_acls(service_name: str = "ec2") -> dict:
    obj = ec2Driver(**account_details)
    all_network_acls = obj.get_all_network_acls(service_name = service_name)
...
def list_of_vpc_connection_peering(service_name: str = "ec2") -> dict:
    obj = ec2Driver(**account_details)
    all_vpc_connection_peering = obj.get_all_vpc_connection_peering(service_name)
...
def list_of_nats_gateway(service_name: str = "ec2") -> dict:
    obj = ec2Driver(**account_details)
    all_nat_gateways = obj.get_all_nat_gateways(service_name)
...
def list_of_internet_gateway(service_name: str = "ec2") -> dict:
    obj = ec2Driver(**account_details)
    all_internet_gateways = obj.get_all_internet_gateways(service_name = service_name)
...
def list_of_route_table(service_name: str = "ec2")->dict:
    
    obj = ec2Driver(**account_details)
    all_route_table = obj.get_all_route_table(service_name)
...
def list_of_subnets(service_name: str = "ec2")->dict:
    
    obj = ec2Driver(**account_details)
    all_subnets = obj.get_all_subnets(service_name=service_name)
...
def list_of_vpcs(service_name: str = "ec2")->dict:
    obj = ec2Driver(**account_details)
    all_vpcs = obj.get_all_vpcs(service_name)
