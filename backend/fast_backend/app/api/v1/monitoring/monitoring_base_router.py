...
router_list = [dashboard_routes, monitoring_device_routes, device_dashboard_routes,
               monitoring_alert_routes, monitoring_credentials_routes,monitoring_network_routes,monitoring_server_routes,monitoring_static_router,monitoring_scheduler_router]
