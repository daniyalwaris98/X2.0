...
class Site_Table(db.Model):
    ...
    region_name = db.Column(db.String(50), nullable=True, default="N/A")
    latitude = db.Column(db.String(70), nullable=True, default="0")
    longitude = db.Column(db.String(70), nullable=True, default="0")
    city = db.Column(db.String(50), nullable=True, default="N/A")
...
class Rack_Table(db.Model):
    ...
    pn_code = db.Column(db.String(50), nullable=True, default="N/A")
    rack_model = db.Column(db.String(50), nullable=True, default="N/A")
    floor = db.Column(db.String(50), nullable=True, default="N/A")
    total_count = db.Column(db.Integer, nullable=True, default=0)
