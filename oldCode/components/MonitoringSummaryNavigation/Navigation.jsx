          ...
          <CenterContainer style={{ textAlign: "center" }}>
            <NavbarLinkContainer>
              {configData?.ipam.pages.ipam.view ? (
                <NavbarLink to="/monitoringsummary/main" activeStyle>
                  <img
                    src={ipam_dashboard}
                    alt=""
                    style={{
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              {configData?.ipam.pages.ipam.view ? (
                <NavbarLink to="/monitoringsummary/interface" activeStyle>
                  <img
                    src={ipam_dashboard}
                    alt=""
                    style={{
              ...
              {/* {configData?.ipam.pages.devices.view ? (
                <NavbarLink to="/ipam/devices" activeStyle>
                  <img
                    src={device}
                    alt=""
                    style={{
              ...
              {/* {configData?.ipam.pages.devices_subnet.view ? (
                <NavbarLink to="/ipam/Device-Subnet" activeStyle>
                  <img
                    src={devices_subnet}
                    alt=""
                    style={{
              ...
              {/* <div class="dropdown">
                ...
                >
                  <div style={{ marginTop: "10px", marginBottom: "10px" }}>
                    <SubNavbarLink to="/ipam/subnet/main" activeStyle>
                      Subnet
                    </SubNavbarLink>
                  </div>
                 
                  <div style={{ marginTop: "10px", marginBottom: "10px" }}>
                    <SubNavbarLink to="/ipam/subnet/ip-details" activeStyle>
                      IP Details
                    </SubNavbarLink>
                  </div>
                  <div style={{ marginTop: "10px", marginBottom: "10px" }}>
                  ...
                  <div style={{ marginTop: "10px", marginBottom: "10px" }}>
                    <SubNavbarLink to="/ipam/subnet/ip-history" activeStyle>
                      IP History
                    </SubNavbarLink>
                  </div>
                </div>
              ...
              {/* <div class="dropdown">
                ...
                >
                  <div style={{ marginTop: "10px", marginBottom: "10px" }}>
                    <SubNavbarLink to="/ipam/dns/main" activeStyle>
                      DNS Server
                    </SubNavbarLink>
                  </div>
                  <div style={{ marginTop: "10px", marginBottom: "10px" }}>
                    <SubNavbarLink to="/ipam/dns/zones" activeStyle>
                      DNS Zones
                    </SubNavbarLink>
                  </div>
                  <div style={{ marginTop: "10px", marginBottom: "10px" }}>
                    <SubNavbarLink to="/ipam/dns/records" activeStyle>
                      DNS Records
                    </SubNavbarLink>
                  </div>
                </div>
