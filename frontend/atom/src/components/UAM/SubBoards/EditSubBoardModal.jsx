...
const EditSubBoardModel = (props) => {
  ...
  const postDevice = async (device) => {
    try {
      //console.log(device);
      await axios
        .post(baseUrl + "/editSubBoard ", device)
        .then((response) => {
  ...
  let [subboard_name, setsubboard_name] = useState(
    device ? getString(device.subboard_name) : ""
  );
  ...
  let [subboard_type, setsubboard_type] = useState(
    device ? getString(device.subboard_type) : ""
  );
  // let [subrack_id, setsubrack_id] = useState(
  //   device ? getString(device.subrack_id) : ""
  // );
  let [subrack_id, setsubrack_id] = useState(
    device ? getString(device.subrack_id) : ""
  );
  let [slot_number, setslot_number] = useState(
    device ? getString(device.slot_number) : ""
  );
  let [subslot_number, setsubslot_number] = useState(
    device ? getString(device.subslot_number) : ""
  );
        ...
        <Row style={{ alignContent: "center" }}>
          ...
          <Col span={7} style={{ marginLeft: "6%" }}>
            ...
            <InputWrapper>
              ...
              <StyledInput
                value={subboard_name}
                onChange={(e) => setsubboard_name(e.target.value)}
                // required
              />
              {/* )} */}
            </InputWrapper>
            ...
            <InputWrapper>
              ...
              <StyledInput
                value={subboard_type}
                onChange={(e) => setsubboard_type(e.target.value)}
                // required
              />
              {/* )} */}
            </InputWrapper>
            ...
            <InputWrapper>
              ...
              <StyledInput
                value={subrack_id}
                onChange={(e) => setsubrack_id(e.target.value)}
                // required
              />
              {/* )} */}
            </InputWrapper>
          ...
          <Col span={7} style={{ marginLeft: "1%" }}>
            <InputWrapper>
              ...
              <StyledInput
                value={subslot_number}
                onChange={(e) => setsubslot_number(e.target.value)}
                // required
              />
              {/* )} */}
            </InputWrapper>
...
export default EditSubBoardModel;
