...
import Router_Navigation from "./Sub_Navigation";
...
const index = () => {
  ...
  useEffect(() => {
    const serviceCalls = async () => {
      ...
      try {
        const res = await axios.get(baseUrl + "/getAllDevicesInRouters");
        console.log("res", res);
        excelData = res.data;
  ...
  return (
    <div>
      <div style={{ backgroundColor: "#FFFFFF", textAlign: "center" }}>
        ...
        >
          <span style={{ color: "rgba(0,0,0,0.5" }}>Network </span>/ Router /
          Devices
        </h3>
