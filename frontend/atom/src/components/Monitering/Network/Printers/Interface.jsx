...
const index_Main = () => {
  ...
  useEffect(() => {
    const serviceCalls = async () => {
      ...
      try {
        const res = await axios.get(baseUrl + "/getAllInterfacesInPrinters");
        console.log("res", res);
        excelData = res.data;
  ...
  return (
    <div>
      <div style={{ backgroundColor: "#FFFFFF", textAlign: "center" }}>
        ...
        >
          <span style={{ color: "rgba(0,0,0,0.5" }}>Network </span>/ Printers /
          Interfaces
        </h3>
      ...
      <div style={{ marginRight: "12px", marginLeft: "12px" }}>
        <div style={{ marginRight: "15px", marginLeft: "15px" }}>
          ...
          <div style={{ display: "flex", marginTop: "5px" }}>
            ...
            &nbsp;&nbsp;
            <h4>Cols :</h4>&nbsp;
            <ColRowNumberStyle>3</ColRowNumberStyle>
          </div>
