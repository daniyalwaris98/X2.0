...
import {
  V1_V2_ELEMENT_NAME as ELEMENT_NAME,
  V1_V2_PAGE_NAME as PAGE_NAME,
...
const Index = () => {
  ...
  const { handleSuccessAlert, handleInfoAlert, handleCallbackAlert } =
    useSweetAlert();
  const { v1V2ColumnDefinitions } = useIndexTableColumnDefinitions({});
  const generatedColumns = useColumnsGenerator({
    columnDefinitions: v1V2ColumnDefinitions,
  });
